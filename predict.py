...
def select_vehicle():
    ...
    global dict
    return count,dict
bole=predictor_two_wheeler(r"datasets\Helmet_Detection-1\test\images\BikesHelmets597_png.rf.635a13ee1759a996ad2e45081f3383e3.jpg")
im=PIL.Image.open(r"datasets\Helmet_Detection-1\test\images\BikesHelmets597_png.rf.635a13ee1759a996ad2e45081f3383e3.jpg")
pyplot.imshow(im)
pyplot.show()